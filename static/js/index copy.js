...
const Index = (function() {
    ...
    async function getRecomendaciones(respuesta){
        ...
        document.querySelector('.data-recomendaciones').innerHTML = `${fArgumentos.recomendaciones}`;
        document.querySelector(".data-recomendaciones").scrollIntoView({ behavior: 'smooth' });
